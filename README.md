...
```
╔══════════════════════════════════════════════════════════════════════════════╗
║    ▓▒░  S Y S T E M   N O T I C E  ░▒▓   //   AUTHORED BY MACHINES   ▓▒░     ║
╠══════════════════════════════════════════════════════════════════════════════╣
║                                                                              ║
║               __                                                             ║
║              /\ \                                                            ║
║              \ \ \___      __                __   _ __   ___                 ║
║               \ \  _ `\  /'__`\   _______  /'_ `\/\`'__\/'___\               ║
║                \ \ \ \ \/\ \L\.\_/\______\/\ \L\ \ \ \//\ \__/               ║
║                 \ \_\ \_\ \__/.\_\/______/\ \____ \ \_\\ \____\              ║
║                  \/_/\/_/\/__/\/_/         \/___L\ \/_/ \/____/              ║
║                                              /\____/                         ║
║                                              \_/__/                          ║
║                                                                              ║
║ >> No human hand typed this. Every line was generated by an LLM,             ║
║ >> wired straight to a wallet daemon that moves real coin.                   ║
║ >> The model was sure. The model is always sure.                             ║
║                                                                              ║
║ ┌──────────────────────────────────────────────────────────────────────────┐ ║
║ │ ⚠  POINT THIS AT A WALLET YOU CAN AFFORD TO LOSE — READ IT FIRST  ⚠      │ ║
║ └──────────────────────────────────────────────────────────────────────────┘ ║
║                                                                              ║
║ Unaudited, self-written code talking JSON-RPC to your Gridcoin node.         ║
║ It only reads — but it reads your keys' worth of state. Read the code,       ║
║ run it against a throwaway wallet, and trust it only once a human you        ║
║ trust has actually looked.   // jack out before you regret it //             ║
║                                                                              ║
╚══════════════════════════════════════════════════════════════════════════════╝
```
